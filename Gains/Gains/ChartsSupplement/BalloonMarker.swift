...
public class BalloonMarker: MarkerImage {
  ...
  public override func refreshContent(entry: ChartDataEntry, highlight: Highlight) {
    ...
    let numSets = Int(exercise!.weights[sortedKeys[index]]!["sets"]!)
    let numReps = Int(exercise!.weights[sortedKeys[index]]!["reps"]!)
    let markerText = "\(numSets)x\(numReps)"
  ...
  func setExercise(weightExercise: WeightExercise) {
